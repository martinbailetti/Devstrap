...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
		<label for="account_first_name"><?php _e( 'First name', 'devstrap' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
		<label for="account_last_name"><?php _e( 'Last name', 'devstrap' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
		<label for="account_email"><?php _e( 'Email address', 'devstrap' ); ?> <span class="required">*</span></label>
	...
	<fieldset>
		<legend><?php _e( 'Password Change', 'devstrap' ); ?></legend>

		<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
			<label for="password_current"><?php _e( 'Current Password (leave blank to leave unchanged)', 'devstrap' ); ?></label>
		...
		<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
			<label for="password_1"><?php _e( 'New Password (leave blank to leave unchanged)', 'devstrap' ); ?></label>
		...
		<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
			<label for="password_2"><?php _e( 'Confirm New Password', 'devstrap' ); ?></label>
	...
	<p>
		...
		<input type="submit" class="btn btn-outline-primary" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'devstrap' ); ?>" />
