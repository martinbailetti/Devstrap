				...
				<main class="site-main" id="main" role="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<?php if ( devstrapp_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>

								<div class="widget widget_categories">

									<h2 class="widget-title"><?php _e( 'Most Used Categories', 'devstrap' ); ?></h2>
